...
export default function BlogCard({ post }: { post: BlogPost }) {
  return (
    <Card className="h-full overflow-hidden border-none shadow-md transition-all duration-300 pb-2 rounded-lg group hover:shadow-lg border-purple-600 border-2">
